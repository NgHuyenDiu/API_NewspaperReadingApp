...
namespace api_test.DAO
{
    public class CommentDAO
    {
        public static int taoMa()
        {
            int maxMa = 0;
            // mo ket noi
            String lenh = String.Format("EXEC sp_timmaxIdComment");
        ...
        public static DataTable getAll(int id_articles)
        {
            String lenh = String.Format("EXEC sp_getAllCommentArticles {0}", id_articles);
